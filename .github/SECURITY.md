...
The "PokemonTCG" team and community take all security bugs in "PokemonTCG" seriously. Thank you for improving the security of "PokemonTCG". We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
- "PokemonTCG" will confirm the problem and determine the affected versions.
- "PokemonTCG" will audit code to find any potential similar problems.
- "PokemonTCG" will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
