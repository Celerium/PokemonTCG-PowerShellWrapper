...
.SYNOPSIS
    Pester tests for the PokemonTCG module manifest file
...
.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-PokemonTCGApiKey.Tests.ps1

    Runs a pester test and outputs simple results

.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-PokemonTCGApiKey.Tests.ps1 -Output Detailed
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'PokemonTCG.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'c6e380f6-4dca-4e91-8fbd-2c05d1eae38a'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/PokemonTCG-PowerShellWrapper/blob/main/LICENSE'
        }
        ...
        It "Manifest [ NestedModules ] has valid data" {
            switch ($buildTarget) {
                ...
                'notBuilt'  { ($Module.NestedModules.Name).Count | Should -Be 20 }
            }
        }

        It "Manifest [ FunctionsToExport ] has valid data" {
            ($Module.ExportedCommands).Count | Should -Be 21
        }
        ...
        It "Manifest [ Tags ] has valid data" {
            $Module.PrivateData.PSData.Tags | Should -Contain 'PokemonTCG'
            $Module.PrivateData.PSData.Tags | Should -Contain 'Celerium'
            ($Module.PrivateData.PSData.Tags).Count | Should -BeGreaterOrEqual 11
        }

        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/PokemonTCG-PowerShellWrapper/blob/main/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/PokemonTCG-PowerShellWrapper'
        }

        It "Manifest [ IconUri ] has valid data" {
            $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/PokemonTCG-PowerShellWrapper/main/.github/images/Celerium_PoSHGallery_PokemonTCG.png'
        }

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/PokemonTCG-PowerShellWrapper/blob/main/README.md'
        }
