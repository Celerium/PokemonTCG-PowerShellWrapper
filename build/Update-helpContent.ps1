...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "PokemonTCG-PowerShellWrapper\docs"
        NO  - "PokemonTCG-PowerShellWrapper\PokemonTCG\docs"

    Example: "C:\Celerium\Projects\PokemonTCG-PowerShellWrapper\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "PokemonTCG-PowerShellWrapper\docs"
    Reference:
        Yes - "PokemonTCG-PowerShellWrapper\docs\Endpoints.csv"
        NO  - "PokemonTCG-PowerShellWrapper\PokemonTCG\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\PokemonTCG-PowerShellWrapper\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/PokemonTCG-PowerShellWrapper"
...
.EXAMPLE
    .\Update-helpContent.ps1
        -moduleName PokemonTCG
        -helpDocsPath "C:\Celerium\Projects\PokemonTCG-PowerShellWrapper\docs"
        -csvFilePath "C:\Celerium\Projects\PokemonTCG-PowerShellWrapper\docs\Endpoints.csv"
        -githubPageUri "https://celerium.github.io/PokemonTCG-PowerShellWrapper"
...
$downloadLink = "$githubPageUri/docs/cab"
    ...
    $moduleDescription = 'This PowerShell module acts as a wrapper for the PokemonTCG API.'
